import {
  ...
  type ClarificationControllerDeps,
} from '../../../app/main/src/windows/clarification-controller';
...
describe('Main IPC LLM Handlers', () => {
  beforeAll(() => {
    ...
    // Override LLM service methods for predictable behavior
    // eslint-disable-next-line @typescript-eslint/unbound-method
    jest.spyOn(LlmIntegrationService.prototype, 'getNextQuestion').mockResolvedValue({
      question: {
        id: 'q2',
        text: 'LLM question',
        options: [
    ...
    // eslint-disable-next-line @typescript-eslint/unbound-method
    jest.spyOn(LlmIntegrationService.prototype, 'generateDraft').mockResolvedValue({
      draft: {
        objectives: [
          {
            id: 'o1',
    ...
    // Instantiate controller with new deps pattern
    const deps: ClarificationControllerDeps = {
      ...
      okrBuilder: new OkrBuilderService(),
      elect: electStub,
    };
